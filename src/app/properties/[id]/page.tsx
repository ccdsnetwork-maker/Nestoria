  ...
  if (!property) {
    return (
      <main className="mx-auto max-w-6xl px-6 py-20">
        ...
        <Link
          href="/properties"
          className="mt-6 inline-block rounded-lg bg-[#0B2E6B] px-5 py-2 text-white"
        >
          Back to Properties
        </Link>
      </main>
    ...
    <main className="bg-gray-100">
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="rounded-2xl bg-white p-6 shadow-xl">
          ...
          <h1 className="mt-5 text-3xl font-bold text-[#0B2E6B]">
            {property.price}
          </h1>
          ...
          <div className="mt-10 rounded-xl border border-gray-200 p-5">
            ...
            <h3 className="text-lg font-bold text-[#0B2E6B]">
              Listed By
            </h3>
