...
export default function HeroContent() {
  return (
    <div className="relative z-20 flex min-h-[85vh] flex-col items-center justify-center px-6 text-center text-white">
      ...
      <span className="rounded-full bg-[#FFF700] px-5 py-2 text-sm font-semibold text-[#0B2E6B] shadow-lg">
      ...
      <div className="mt-10 flex flex-col gap-4 sm:flex-row">
        ...
        <Link
          href="/properties"
          className="rounded-xl bg-[#FFF700] px-8 py-4 font-bold text-[#0B2E6B] transition hover:scale-105"
        >
          Browse Properties
        </Link>
